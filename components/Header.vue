...
<template>
  <header class="bg-white">
    ...
    <div v-else>
      <button @click="logOut" class="border-2 border-red-700 py-2 px-6 text-red-700 text-lg font-semibold hover:bg-red-600 hover:text-white">Log Out</button>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <NuxtLink to="https://staywonderfulworld.org/" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Shop</NuxtLink>
